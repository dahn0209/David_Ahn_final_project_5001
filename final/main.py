from database import set_user_db, create_new_user_db, get_current_db, delete_user_db, initialize_user_db
from user_management import sign_up, sign_in, sign_out, update_password, delete_user, get_current_user


def main():
    """
    A command-line interface for thea user system involving setting a user database, signing up, signing in, updating passwords, and deleting users or 
    databases. It runs in a loop until the user selects the exit option.
